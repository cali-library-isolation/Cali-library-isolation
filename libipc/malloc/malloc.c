...
/*
  ...
  a /usr/other_inclues/malloc.h defining struct mallinfo. (If you'd like to
...
*/
void*  __libc_shm_malloc(size_t);
libc_hidden_proto (__libc_shm_malloc)
...
*/
void     __libc_shm_free(void*);
libc_hidden_proto (__libc_shm_free)
...
/*
  ...
  set to zero.
*/
void*  __libc_shm_calloc(size_t, size_t);
...
*/
void*  __libc_shm_realloc(void*, size_t);
libc_hidden_proto (__libc_shm_realloc)
...
*/
void*  __libc_shm_memalign(size_t, size_t);
libc_hidden_proto (__libc_shm_memalign)
...
*/
int      __libc_shm_mallopt(int, int);
libc_hidden_proto (__libc_shm_mallopt)
...
/*
  ...
  thus be inaccurate.
*/
struct mallinfo __libc_shm_mallinfo(void);
 ...
 */
void*  __libc_shm_pvalloc(size_t);
...
*/
size_t   __shm_malloc_usable_size(void *);
...
/*
  ...
  structure.
*/
void*  __shm_malloc_get_state(void);
...
/*
  ...
  malloc_get_state().
*/
int      __shm_malloc_set_state(void *);
...
*/
int      __posix_shm_memalign(void **, size_t, size_t);
...
static void*  _int_shm_realloc(mstate, mchunkptr, INTERNAL_SIZE_T,
			   INTERNAL_SIZE_T);
...
void weak_variable (*__shm_malloc_initialize_hook) (void) = NULL;
void weak_variable (*__shm_free_hook) (void *__ptr,
                                   const void *) = NULL;
void *weak_variable (*__shm_malloc_hook)
  (size_t __size, const void *) = malloc_hook_ini;
void *weak_variable (*__shm_realloc_hook)
  (void *__ptr, size_t __size, const void *)
  = realloc_hook_ini;
void *weak_variable (*__shm_memalign_hook)
  (size_t __alignment, size_t __size, const void *)
  = memalign_hook_ini;
void weak_variable (*__shm_after_morecore_hook) (void) = NULL;
      ...
      if (brk != (char *) (MORECORE_FAILURE))
        {
          ...
          void (*hook) (void) = atomic_forced_read (__shm_after_morecore_hook);
...
void *
__libc_shm_malloc (size_t bytes)
{
  mstate ar_ptr;
  void *victim;

  void *(*hook) (size_t, const void *)
    = atomic_forced_read (__shm_malloc_hook);
  if (__builtin_expect (hook != NULL, 0))
...
libc_hidden_def (__libc_shm_malloc)

void
__libc_shm_free (void *mem)
{
  // shm_debug("__libc_shm_free(%p);\n", mem);
  mstate ar_ptr;
  mchunkptr p;                          /* chunk corresponding to mem */

  void (*hook) (void *, const void *)
    = atomic_forced_read (__shm_free_hook);
  if (__builtin_expect (hook != NULL, 0))
    {
...
libc_hidden_def (__libc_shm_free)

void *
__libc_shm_realloc (void *oldmem, size_t bytes)
{
  mstate ar_ptr;
  ...
  void *(*hook) (void *, size_t, const void *) =
    atomic_forced_read (__shm_realloc_hook);
  if (__builtin_expect (hook != NULL, 0))
  ...
  if (bytes == 0 && oldmem != NULL)
    {
      __libc_shm_free (oldmem); return 0;
    }
#endif

  /* realloc of null is supposed to be same as malloc */
  if (oldmem == 0)
    return __libc_shm_malloc (bytes);
  ...
  if (chunk_is_mmapped (oldp))
    {
      ...
      newmem = __libc_shm_malloc (bytes);
      if (newmem == 0)
  ...
  newp = _int_shm_realloc(ar_ptr, oldp, oldsize, nb);
...
libc_hidden_def (__libc_shm_realloc)

void *
__libc_shm_memalign (size_t alignment, size_t bytes)
{
...
_mid_memalign (size_t alignment, size_t bytes, void *address)
{
  ...
  void *(*hook) (size_t, size_t, const void *) =
    atomic_forced_read (__shm_memalign_hook);
  if (__builtin_expect (hook != NULL, 0))
...
/* For ISO C11.  */
weak_alias (__libc_shm_memalign, shm_aligned_alloc)
libc_hidden_def (__libc_shm_memalign)

void *
__libc_shm_valloc (size_t bytes)
{
...
void *
__libc_shm_pvalloc (size_t bytes)
{
  if (__malloc_initialized < 0)
    ptmalloc_init ();
...
void *
__libc_shm_calloc (size_t n, size_t elem_size)
{
  mstate av;
  mchunkptr oldtop, p;
...
void*
_int_shm_realloc(mstate av, mchunkptr oldp, INTERNAL_SIZE_T oldsize,
				 INTERNAL_SIZE_T nb)
{
...
size_t
__shm_malloc_usable_size(void *m)
{
  size_t result;
...
int
__libc_shm_mallopt (int param_number, int value)
{
...
libc_hidden_def (__libc_shm_mallopt)
...
int
__posix_shm_memalign(void **memptr, size_t alignment, size_t size)
{
  void *mem;
...
weak_alias (__posix_shm_memalign, posix_shm_memalign)


int
__shm_malloc_info(int options, FILE *fp)
{
  /* For now, at least.  */
  if (options != 0)
    return EINVAL;
...
weak_alias (__shm_malloc_info, shm_malloc_info)


strong_alias (__libc_shm_calloc, __shm_calloc) weak_alias (__libc_shm_calloc, shm_calloc)
strong_alias (__libc_shm_free, __shm_cfree) weak_alias (__libc_shm_free, shm_cfree)
strong_alias (__libc_shm_free, __shm_free) strong_alias (__libc_shm_free, shm_free)
strong_alias (__libc_shm_malloc, __shm_malloc) strong_alias (__libc_shm_malloc, shm_malloc)
strong_alias (__libc_shm_memalign, __shm_memalign)
weak_alias (__libc_shm_memalign, shm_memalign)
strong_alias (__libc_shm_realloc, __shm_realloc) strong_alias (__libc_shm_realloc, shm_realloc)
strong_alias (__libc_shm_valloc, __shm_valloc) weak_alias (__libc_shm_valloc, shm_valloc)
strong_alias (__libc_shm_pvalloc, __shm_pvalloc) weak_alias (__libc_shm_pvalloc, shm_pvalloc)
strong_alias (__libc_shm_mallinfo, __shm_mallinfo)
weak_alias (__libc_shm_mallinfo, shm_mallinfo)
strong_alias (__libc_shm_mallopt, __shm_mallopt) weak_alias (__libc_shm_mallopt, shm_mallopt)

weak_alias (__shm_malloc_stats, shm_malloc_stats)
weak_alias (__shm_malloc_usable_size, shm_malloc_usable_size)
weak_alias (__shm_malloc_trim, shm_malloc_trim)
weak_alias (__shm_malloc_get_state, shm_malloc_get_state)
weak_alias (__shm_malloc_set_state, shm_malloc_set_state)
